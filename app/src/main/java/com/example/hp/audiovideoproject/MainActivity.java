...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPlay.setOnClickListener(MainActivity.this);                      // setting onClickListeners to buttons
...
//        });
        ...
        seekBarMove.setOnSeekBarChangeListener(MainActivity.this);          // thanks to implementing interface SeekBar.OnSeekBarChangeListener
